...
function App() {
    ...
    function connectWs() {
      ...
      function ProcessData1() {
        ...
        if (latestMessage.current) {
          try {
            const msg = JSON.parse(latestMessage.current);
            ...
            const isHand = payload.includes(
              "PerceptionInputType.HAND_LANDMARKS"
            );
            ...
            if (bbox) {
              ...
              if (cx !== 134 && cy !== 309) targetRef.current.x = cx;
      ...
      function ProcessData() {
        ...
        try {
          ...
          if (bbox) {
            ...
            // ✅ 合格的 bbox
            const cx = Math.round((left + right) / 2) + 200;
            const cy = Math.round((top + bottom) / 2) + 100;
  ...
  return (
    <div className="app-container">
      ...
      >
        {websocketReady ? "Ws Connected" : "Ws Not Connected"}
      </div>
